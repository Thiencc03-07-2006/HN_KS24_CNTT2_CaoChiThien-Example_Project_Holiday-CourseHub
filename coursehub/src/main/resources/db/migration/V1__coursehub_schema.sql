-- ============================================================
-- CourseHub - Flyway Migration V1: Schema (Consolidated v2.0)
-- Source: database/01_schema.sql
-- Replaces: V1__init_schema.sql + V4__add_course_block_fields.sql
--           + V5__add_course_reject_fields.sql
-- Run order: 1st (creates all 30 tables)
-- ============================================================
-- ============================================================
